# https://medium.com/decodingml/how-to-build-a-real-time-news-search-engine-using-serverless-upstash-kafka-and-vector-db-6ba393e55024#fa7d
import streamlit as st
from utils import st_def

st_def.st_logo(title='Welcome 👋 Kafka', page_title="Welcome!",)
